...
formData.append(`resume`, resumeAnalysisInput.resume);
formData.append(`email`, resumeAnalysisInput.email);
if(resumeAnalysisInput.role !== undefined) {
 formData.append(`role`, resumeAnalysisInput.role);
 }
if(resumeAnalysisInput.customRole !== undefined) {
 formData.append(`customRole`, resumeAnalysisInput.customRole);
 }
